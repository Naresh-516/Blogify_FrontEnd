...
function ViewUsers() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-50 to-white p-8">
      <h1 className="text-4xl font-extrabold mb-8 text-center text-blue-700">User Management</h1>
          ...
          <tbody className="text-gray-700 text-sm font-medium">
            {currentUsers.length > 0 ? (
              currentUsers.map(user => (
                <tr key={user.userId} className="border-b hover:bg-blue-50 transition duration-300">
                  ...
                  <td className="py-4 px-6 text-center">{Array.isArray(user.blogs) ? user.blogs.length : 0}</td>
